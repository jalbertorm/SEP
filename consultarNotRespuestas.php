                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="consultarNotRespuestas.php"><i class="fa fa-circle-o"></i> Respuestas</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Notificación de Respuestas</h3>
                                    ...
                                    <form action="guardarUsuario.php" method="POST">
                                        <div class="box-body">
                                            <?php tablaNotificacionesRespuesta(); ?>
                                        </div><!-- /.box-body -->
