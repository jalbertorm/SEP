...
if ($_SESSION["Activa"] && $_POST and $_SESSION["Tipo_usuario"] = "normal") {
    ...
    $asuntoMail = 'Oficio No. '.$datosOficio['noOficio'].', Referencia: '.$datosOficio['referencia'].', Folio: '.$datosOficio['folio'].'. Coordinación General de Atención Ciudadana, Delegación SEP Estado de México';

    $cuerpoMail = '<p style="font-size: large;">
                                Por medio del presente, se adjunta oficio que contiene petición del C. '.$datosOficio['ciudadano'].'; de antemano, agradezco la atención prestada. 
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="box box-solid box-default">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Enviar a Dependencia</h3>
                                    </div>
