                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    ...
                                    <form action="guardarENotRespuestas.php" method="POST">
                                        <div class="box-body">
                                            <div class="form-group col-md-12 col-md-offset-0">
                                                <textarea placeholder="Redactar Saludo" name="texto" required				
                                                          ...
                                                          border: 1px solid #dddddd; padding: 10px;" class="textareaNotRespuestas"
                                                          maxlength="3">
                                                              <?php echo $datos['redaccionRespuestas']; ?>
                                                </textarea>
                                                <div id="divAuxNotRespuestas"></div>
                                                <div hidden="true">
                                                    <input type="text" value="OK" id="inputAuxNotRespuestas" required>
                                                </div>
                                            </div>
                                        </div><!-- /.box-body -->
