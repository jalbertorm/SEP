    ...
    <html>
        ...
        <body class="skin-black-light sidebar-mini">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    ...
                                    <form action="guardarEUsuario.php" method="POST">
                                        <div class="box-body">
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">Usuario</label>
                                                <input type="text" class="form-control" name="usu" id="usu" placeholder="Usuario" value="<?php echo $datos['usuario']; ?>" onkeypress="return limitausuario(event, 20);" onkeyup="actualizaInfousuario(20)" required />
                                                <div id="rUsu"></div>
                                                <div id="rusuario"></div>
                                            </div>
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">¿Desea cambiar la contraseña?</label>
                                                <select class="form-control" name="cambiarPass" id="cambiarPass" required>
                                                    <option value="">Selecciona una opción</option>
                                                    <option value="si">Si</option>
                                                    <option value="no">No</option>
                                                </select>
                                            </div>
                                            <div id="divCambiarPass">
                                                <div class="form-group col-md-6 col-md-offset-3">
                                        ...
                                        <div class="box-footer text-right">
                                            <a class="btn btn-default" href="consultarUsuario.php"  onClick="return confirm('¿Está seguro que desea cancelar?, No se guardará ningún cambio!');">Cancelar</a>
                                            &nbsp;
            ...
            <script type="text/javascript">
                ...
                $(function () {
                    $('#divCambiarPass').hide();
                    $('#cambiarPass').change(function () {
                        switch ($('#cambiarPass').val()) {
                            case 'si':
                                $('#divCambiarPass').show();
                                break;
                            case 'no':
