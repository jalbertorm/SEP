        ...
        <body class="skin-black-light sidebar-mini">
                    ...
                    <section class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="altaDependencia.php"><i class="fa fa-circle-o"></i> Nueva Dependencia</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    ...
                                    <form action="guardarDependencia.php" method="POST">
                                        <div class="box-body">
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">Renglón 1</label>
                                                <input type="text" class="form-control" name="Rn1" id="Rn1" placeholder="Escriba aquí" required onkeypress="return limitaRn1(event, 36);" onkeyup="actualizaInfoRn1(36)" />
                                                <div id="maxRn1"></div>
                                                <div hidden="true">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                ...
                                                <input type="text" class="form-control" name="Rn2" id="Rn2" placeholder="Escriba aquí" required onkeypress="return limitaRn2(event, 36);" onkeyup="actualizaInfoRn2(36)" />
                                                <div id="maxRn2"></div>
                                                <div hidden="true">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                ...
                                                <input type="text" class="form-control" name="Rn3" id="Rn3" placeholder="Escriba aquí" required onkeypress="return limitaRn3(event, 46);" onkeyup="actualizaInfoRn3(46)" />
                                                <div id="maxRn3"></div>
                                                <div hidden="true">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                ...
                                                <input type="text" class="form-control" name="Rn4" id="Rn4" placeholder="Escriba aquí" required onkeypress="return limitaRn4(event, 36);" onkeyup="actualizaInfoRn4(36)" />
                                                <div id="maxRn4"></div>
                                                <div hidden="true">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                ...
                                                <input type="text" class="form-control" name="Rn5" id="Rn5" placeholder="Escriba aquí" required onkeypress="return limitaRn5(event, 11);" onkeyup="actualizaInfoRn5(11)" />
                                                <div id="maxRn5"></div>
                                                <div hidden="true">
                                            ...
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                ...
                                                <input type="email" class="form-control" name="mail" id="mail" placeholder="Correo Electrónico" required onkeypress="return limitaMail(event, 66);" onkeyup="actualizaInfoMail(66)" />
                                                <div id="maxMail"></div>
                                                <div id="rMail"></div>
                                                <div hidden="true">
            ...
            <script type="text/javascript">
                ...
                function actualizaInfoRn5(maximoCaracteres) {
                    ...
                    if (elemento.value.length >= maximoCaracteres) {
                        info.innerHTML = "<font style=' color: #CC0000'>Alcanzó el máximo número de caracteres permitido.</font>";
                        $("#inputAuxDependencia5").val("");
                    }
                    else {
                        info.innerHTML = "";
                        $("#inputAuxDependencia5").val("OK");
                    }
                }
                ...
                function actualizaInfoMail(maximoCaracteres) {
                    ...
                    if (elemento.value.length >= maximoCaracteres) {
                        info.innerHTML = "<font style=' color: #CC0000'>Alcanzó el máximo número de caracteres permitido.</font>";
                        $("#inputAuxDependencia6").val("");
                    }
                    else {
                        info.innerHTML = "";
                        $("#inputAuxDependencia6").val("OK");
                    }
                }
