                    ...
                    <section class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="altaRevisor.php"><i class="fa fa-circle-o"></i> Nuevo Revisor</a></li>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Nuevo Revisor</h3>
                                        <div class="box-tools pull-right">
                                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Minimizar"><i class="fa fa-minus"></i></button>
                                        </div>
                                    </div>
                                    <form action="guardarRevisor.php" method="POST">
                                        <div class="box-body">
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">Nombre</label>
                                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre del Revisor" required onkeypress="return limita(event, 36);" onkeyup="actualizaInfo(36)" />
                                                <div id="max"></div>
                                                <div hidden="true">
                                                    <input type="text" value="OK" id="inputAuxRevisor" required>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">Correo Electrónico Revisor</label>
                                                ...
                                                <div id="rMail"></div>
                                                <div hidden="true">
                                                    <input type="text" value="OK" id="inputAuxRevisor2" required>
                                                </div>
                                            </div>
                                        </div><!-- /.box-body -->
            ...
            <script type="text/javascript">
                ...
                function actualizaInfoMail(maximoCaracteres) {
                    ...
                    if (elemento.value.length >= maximoCaracteres) {
                        ...
                        $("#inputAuxRevisor2").val("");
                    }
                    else {
                        info.innerHTML = "";
                        $("#inputAuxRevisor2").val("OK");
                    }
                }
