                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="box box-solid box-default">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Editar Revisor</h3>
                                        <div class="box-tools pull-right">
                                            <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Minimizar"><i class="fa fa-minus"></i></button>
                                        </div>
                                    </div>
                                    <form action="guardarERevisor.php" method="POST">
                                        <div class="box-body">
                                            <div class="form-group col-md-6 col-md-offset-3">
                                                <label for="exampleInputEmail1">Nombre</label>
                                                <input value="<?php echo $datos['nombre']; ?>" type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre del Revisor" required onkeypress="return limita(event, 36);" onkeyup="actualizaInfo(36)" />
                                                <div id="max"></div>
                                                <div hidden="true">
                                        ...
                                        <div class="box-footer text-right">
                                            <a class="btn btn-default" href="consultarRevisor.php"  onClick="return confirm('¿Está seguro que desea cancelar?, No se guardará ningún cambio!');">Cancelar</a>
                                            &nbsp;
